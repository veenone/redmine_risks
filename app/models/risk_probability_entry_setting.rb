class RiskProbabilityEntrySetting < ActiveRecord::Base
  ...
  # Default probability level options (different from probability points)
  DEFAULT_SETTINGS = [
    { key: 'unlikely', label: 'Unlikely', description: 'Very low chance of occurring' },
    { key: 'low', label: 'Low', description: 'Low probability of occurrence' },
    { key: 'medium', label: 'Medium', description: 'Moderate probability of occurrence' },
    { key: 'high', label: 'High', description: 'High probability of occurrence' },
    { key: 'expected', label: 'Expected', description: 'Almost certain to occur' }
  ].freeze
