class RiskProbabilityPointSetting < ActiveRecord::Base
  ...
  # Default probability point configuration (used when project has no custom settings)
  DEFAULT_SETTINGS = [
    { score: 1, label: 'Very Low', description: 'Mechanisms preventing or deterring against the incident are in place.' },
    { score: 2, label: 'Low', description: 'Mechanisms insuring the detection and/or the limitation of the incident are in place.' },
    { score: 3, label: 'Medium', description: 'Only procedural counter-measures are in place.' },
    { score: 4, label: 'High', description: 'No counter-measures are in place.' }
  ].freeze
